...
function init() {
    ...
    manager.onLoad = function () {
        ...
        for(var i=0; i<object.children.length; i++) 
        {
            newGeometry.merge(object.children[i].children[0].geometry);
            object
        }
    ...
    loader.load( 'assets/PaCaLa_hex_round_V1_web_v12.3mf', 
    ...
    */
    ...
    if(now >= nextStats) {
        ...
        if(debugModel) 
        {
            ...
            console.log("Scene pointcount:", renderer.info.render.points);
